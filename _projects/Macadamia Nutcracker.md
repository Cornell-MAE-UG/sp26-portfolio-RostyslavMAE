...
- The handle and the actuation mechanism, assumed to be cylindrical with a rubber grip, would be able to withstand the bending force because of their significant diameter of 2 centimeters.
...
3. Your approach to the problem (e.g. calculations, assumptions made, your thought
process, etc.)
4. A diagram of your nut cracker design. This doesn't need to be fancy, but should be
intelligible.
